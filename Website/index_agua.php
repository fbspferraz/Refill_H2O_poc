...
<body onload="changeAgua();">
	...
	<div class="body">
		...
		<section class="section-1 left" >
			...
			<input class="text1" type="date" id="start" name="start" onchange="changeAgua()">
			<span for="end" class="text2">Data de fim:</label>
			<input class="text1" type="date" id="end" name="end" onchange="changeAgua()">
		</section>
		<section class="section-1 right">
			<iframe id="iframeGraphic" src="http://62.28.241.83:3000/d-solo/CS4T2cznk/refill_2?orgId=1&from=1624858723821&to=1624945123821&var-Curso=&var-Turma=&var-UnidadeOrganica=&var-User=&panelId=15" width="600" height="350" frameborder="1"></iframe>
		</section>
	</div>
</body>
