...
<body onload="changeCurso();">
	...
	<div class="body">
		...
		<section class="section-1 left">
			...
			<input class="text1" type="date" id="start" name="start" onchange="changeCurso()">
			<span for="end" class="text2">Data de fim:</label>
			<input class="text1" type="date" id="end" name="end" onchange="changeCurso()">
		</section>
