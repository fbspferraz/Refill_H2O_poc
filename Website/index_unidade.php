	...
	<div class="body">
		...
		<section class="section-1 left">
			<span class="text2">
				...
				<select class="text1" name="uniOrganica" id="uniOrganica" onchange="changeUniOrganica()">
			...
			<input class="text1" type="date" id="start" name="start" onchange="changeUniOrganica()">
			<span for="end" class="text2">Data de fim:</label>
			<input class="text1" type="date" id="end" name="end" onchange="changeUniOrganica()">

		</section>
		<section class="section-1 right">
			<iframe id="iframeGraphic" src="http://62.28.241.83:3000/d-solo/CS4T2cznk/refill_2?orgId=1&from=1624857355524&to=1624943755524&var-Curso=&var-Turma=&var-UnidadeOrganica=1&var-User=&panelId=11" width="600" height="350" frameborder="1"></iframe>
		</section>
	</div>
</body>
