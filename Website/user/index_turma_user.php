		...
		<nav class="side-bar">
			...
			<section class="section-1 left">
				<span class="text2">
					...
					<select class="text1" name="uniOrganica" id="uniOrganica" onchange="changeTurma()">
				...
				<span class="text2">
				Selecione um curso:
				<select class="text1" name="curso" id="curso" onchange="changeTurma()">
				...
				<span class="text2" >
					Selecione uma turma:
						<select class="text1" name="turma" id="turma" onchange="changeTurma()">
				...
				<input class="text1" type="date" id="start" name="start" onchange="changeTurma()">
				<span for="end" class="text2">Data de fim:</label>
				<input class="text1" type="date" id="end" name="end" onchange="changeTurma()">
			</section>
			<section class="section-1 right">
				<iframe id="iframeGraphic" src="http://62.28.241.83:3000/d-solo/CS4T2cznk/refill_2?orgId=1&from=1624857770627&to=1624944170627&var-Curso=0&var-Turma=0&var-UnidadeOrganica=1&var-User=&panelId=13" width="600" height="350" frameborder="1"></iframe>	
			</section>
	</div>
</body>
